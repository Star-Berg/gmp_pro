 ...
 */
#define GFL_LEVEL6_VOLTAGE_D_KP (0.03f)
 ...
 */
#define GFL_LEVEL6_VOLTAGE_Q_KP (0.03f)
 ...
 */
#define GFL_LEVEL6_NEG_VOLTAGE_KP (0.03f)
 ...
 */
#define GFL_LEVEL67_DCBUS_FEEDFORWARD_MIN_GAIN (0.95f)
