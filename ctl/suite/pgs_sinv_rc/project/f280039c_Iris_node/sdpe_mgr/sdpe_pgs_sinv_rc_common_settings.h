 ...
 */
#define SINV_FDRC_FREEZE_ERROR_PU 0.05
 ...
 */
#define SINV_POWER_LOOP_KI (10.0f)

/**
 * @brief DC-bus outer-loop proportional gain.
 */
#define SINV_DC_BUS_LOOP_KP (0.4f)

/**
 * @brief DC-bus outer-loop integral gain per second.
 */
#define SINV_DC_BUS_LOOP_KI (8.0f)

/**
 * @brief BUILD_LEVEL 5 DC-bus feedback first-order low-pass cutoff frequency in Hz.
 */
