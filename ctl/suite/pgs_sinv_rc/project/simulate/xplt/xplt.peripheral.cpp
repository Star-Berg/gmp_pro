...
void setup_peripheral(void)
{
    ...
    ctl_init_adc_channel(&adc_v_buck_out,
        ctl_gain_calc_generic(CTRL_ADC_VOLTAGE_REF, CTRL_BUCK_OUTPUT_VOLTAGE_SENSITIVITY, CTRL_VOLTAGE_BASE),
        ctl_bias_calc_via_Vref_Vbias(CTRL_ADC_VOLTAGE_REF, CTRL_BUCK_OUTPUT_VOLTAGE_BIAS), CTRL_ADC_RESOLUTION, 24);
}
